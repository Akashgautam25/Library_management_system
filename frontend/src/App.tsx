            ...
            <UIProvider>
                <Router>
                    <Routes>
                        ...
                        <Route path="/books" element={<AppLayout><BookListPage /></AppLayout>} />
                        ...
                        <Route path="/issue-return" element={<AppLayout><ProtectedRoute><IssueReturnPage /></ProtectedRoute></AppLayout>} />
